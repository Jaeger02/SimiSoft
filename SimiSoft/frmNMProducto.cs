        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (Validar())
            {
                if (producto == null)
                {
                    ...
                    {
                        XtraMessageBox.Show("Producto insertado correctamente", Application.ProductName,
                ...
                else
                {
                    ...
                    {
                        XtraMessageBox.Show("Producto modificado correctamente", Application.ProductName,
                            MessageBoxButtons.OK, MessageBoxIcon.Information);
                        this.Close();
                    }
                    else
